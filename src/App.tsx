...
let keywords = "construction company india, construction company in amroha, construction company in hasanpur, construction company in moradabad, construction company in sambhal, construction company in noida, construction company in uttar pradesh, construction company in delhi ncr, construction company in haryana, construction company in uttarakhand, industrial construction company, commercial construction company, warehouse construction company, factory construction company, peb structure contractor, lgsf construction company, steel structure contractor, turnkey construction company, civil contractor india";
    if (activeTab === 'home') {
    title = "Construction Company in India | PEB, LGSF, Warehouse & Factory Construction | Tasha Contracts India";
      description = "Tasha Contracts India is a trusted industrial and commercial construction company delivering PEB structures, LGSF buildings, warehouses, factories, commercial buildings and turnkey construction projects across India. Serving Amroha, Hasanpur, Moradabad, Sambhal, Noida, Delhi NCR, Haryana, Uttarakhand and all over India.";
          ...
          >
            ...
            >
              ...
              <div className="relative z-10 max-w-2xl space-y-6 md:space-y-8">
                ...
                >
                  {systemInfo.subheading || "Trusted residential & commercial construction experts delivering quality, safety, and on-time results across India circles."}
                </motion.p>
